...
SELECT * FROM (
    ...
    SELECT 'adbd95cc-26c0-4abd-9f0c-c7e00e026d7e', 128653, 6001, 'sangho11', 'yeji86', '2', '전라북도 수원시 팔달구 선릉거리' UNION ALL
    SELECT 'dd6bed9d-ba45-4d3b-a844-606e3cfdfe2b', 79594, 6001, 'jiu52', 'jiu52', '3', '경상남도 보령시 가락408로' UNION ALL
    SELECT 'f5591955-ce0b-4584-ac08-7488db9c6b31', 145302, 6001, 'sangho11', 'areum92', '4', '제주특별자치도 안양시 동안구 봉은사3로 (현정김마을)' UNION ALL
    SELECT '55203d3b-76c7-49bb-b54e-be54a93c7de9', 25570, 6001, 'coegyeongsu', 'yeji86', '5', '대전광역시 종로구 서초대1로 (영수이김동)'
) AS tmp
...
SELECT * FROM (
    ...
    SELECT 'adbd95cc-26c0-4abd-9f0c-c7e00e026d7e', '2025-05-20 02:26:15', '', '2025-05-20 02:26:15', '' UNION ALL
