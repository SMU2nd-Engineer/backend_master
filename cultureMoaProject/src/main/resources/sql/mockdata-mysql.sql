...
SELECT * FROM (
    SELECT 1, 32, 1, '2025-05-20', NULL UNION ALL  -- 늦은 시간에 연락해요
    SELECT 2, 29, 1, '2025-05-20', NULL UNION ALL  -- 약속 시간을 잘 지켜요
    SELECT 3, 27, 1, '2025-05-20', NULL UNION ALL  -- 물건이 깨끗해요
    SELECT 4, 25, 1, '2025-05-20', NULL UNION ALL  -- 답변이 빨라요
    SELECT 5, 25, 1, '2025-05-20', NULL             -- 답변이 빨라요
) AS tmp
...
SELECT * FROM (
    SELECT 1, 31, '2025-05-20', 1, NULL UNION ALL  -- 이미지와 상품이 달라요
    SELECT 2, 27, '2025-05-20', 0, NULL UNION ALL  -- 물건이 깨끗해요
    SELECT 3, 32, '2025-05-20', 1, NULL UNION ALL  -- 늦은 시간에 연락해요
    SELECT 4, 33, '2025-05-20', 1, NULL UNION ALL  -- 불친절해요
    SELECT 5, 34, '2025-05-20', 1, NULL            -- 사기당했어요!
) AS tmp
