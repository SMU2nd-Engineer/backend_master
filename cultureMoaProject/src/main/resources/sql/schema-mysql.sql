...
(
    ...
    CONSTRAINT PRODUCT_FK FOREIGN KEY(CATEGORY_IDX) REFERENCES CATEGORYSUB_TBL(SUB_IDX)
);
...
(
    ...
    CONSTRAINT USER_REVIEW_EVALUATION_FK2 FOREIGN KEY(CATEGORYSUB_IDX) REFERENCES CATEGORYSUB_TBL(IDX),
