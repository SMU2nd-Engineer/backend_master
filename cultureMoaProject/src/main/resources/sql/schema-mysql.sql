...
(
    ...
    CONSTRAINT PRODUCT_FK FOREIGN KEY(CATEGORY_IDX) REFERENCES CATEGORY_TBL(IDX)
);
...
(
    ...
    REVIEW varchar(255),
    SDATE date NOT NULL,
    CONSTRAINT USER_REVIEW_FK FOREIGN KEY(USER_IDX) REFERENCES USER_TBL(IDX)
);
...
(
    ...
    CONSTRAINT USER_FAVORITE_FK2 FOREIGN KEY(CATEGORYSUB_IDX) REFERENCES CATEGORYSUB_TBL(IDX)
);
...
(
    ...
    CONTENTS_IDX int NOT NULL,
    IMAGE_URL TEXT NOT NULL,
    CONSTRAINT CONTENTS_FK FOREIGN KEY(CONTENTS_IDX) REFERENCES CONTENTS_TBL(IDX)
);
...
(
    ...
    IMG text,
    ETC varchar(512),
    CONSTRAINT TICKET_FK FOREIGN KEY(SUB_IDX) REFERENCES CATEGORY_TBL(IDX)
);
